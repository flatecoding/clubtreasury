...
public interface ICategoryService
{
    ...
    Task<IEnumerable<CategoryModel>> GetCategoriesByCostCenterIdAsync(int costCenterId, CancellationToken ct = default);
    Task<Result> AddCategoryAsync(CategoryModel category, CancellationToken ct = default);
    Task<Result> UpdateCategoryAsync(CategoryModel category, CancellationToken ct = default);
